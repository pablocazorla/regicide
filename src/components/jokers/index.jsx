...
const Jokers = () => {
  const { jokers, visible, setVisible, useJoker } = useJokers();
  ...
  return (
    <>
      ...
      >
        <div className="border border-dotted border-green-500  pt-2 rounded-lg">
          <div className="flex items-center justify-center text-2xl gap-3 px-3">
            <div
              className={clsx({
                "text-black/40": !jokers,
      ...
      <Modal visible={visible}>
        ...
        <div className="p-4 text-center text-sm">
          <strong>Descarta tu mano</strong>,
          <br />y luego roba hasta <strong>8 cartas</strong>.
        </div>
        <div className="flex items-center justify-center gap-4 pt-3 pb-5">
          ...
          >
            ...
            <div className="leading-none">Usar</div>
          </button>
        </div>
      </Modal>
    </>
